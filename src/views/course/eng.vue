                ...
                <div class="ecrw-dao-wrap">
                    ...
                    <div class="ecrw-ready-wrap">
                        <div class="ecrw-ready-wrap-left">
                            <ecr-twolabels ref="twolabels" onelabel="培生英语课程" @item-select="onTwolabelSelect" @item-deselect="onTwolabelDeselect"></ecr-twolabels>
                        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            onTwolabelDeselect(item) {
                if (this.$refs.twolabels.selectedItem == null) {
                    this.twolabel = "";    
                }
                this.load();  
            }
