                    ...
                    <div class="ecrw-zhengji-upload-wrap">
                        ...
                        <div class="ecrw-zhengji-upload-det">
                            ...
                            <el-form ref="form" :model="form" :rules="formRules" label-width="90px" style="margin:20px;" class="ecrm-upload-resource">
                                <el-form-item label="上传资源 :" prop="name" class="is-required">
                                    <span>
                        ...
                        <div style="text-align: center; margin-bottom: 50px">
                            ...
                            <span>
                                <el-button type="primary" @click="doUpload" :loading="saveLoading">提交</el-button>
                            </span>
                        </div>
...
<script>
    ...
    import { getSubjectList ,   getSchoolSectionList, getNaviGradeList,  getFileList,getNaviEditionTypeList,getTeachCatalogList, getNaviBookModelList, getTeachCatalogHeader, getCatalogList, uploadFile, uploadFileInfo, uploadRewardResource, getActivityResourceList, getRewardActivity, getUserCountInfo } from '../../api/api';
    ...
    export default {
        ...
        methods: {
            ...
            getActivityInfo() {
                getRewardActivity(this.activityid).then((res) => {
                    if (res.data.serverResult.resultCode == "200") {
            ...
            doUpload: function() {                
                this.$refs.form.validate((valid) =>{
                    if(valid) {
                        ...
                        uploadRewardResource(para).then((res) => {
                            if (res.data.serverResult.resultCode == "200") {
